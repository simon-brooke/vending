...
Two middleware functions are provided by default in the `vending.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `vending.handler` namespace to manage the enabled middleware.
